...
<META HTTP-EQUIV="Expires" CONTENT="-1">
    ...
    <SCRIPT Language="JavaScript">
		...
		function returnToPort(isAdminUi) {
			var url = '';
			if(isAdminUi) {
				url = '../WmRoot/security-ports.dsp?webMethods-wM-AdminUI=true';
			}
			if(!isAdminUi) {
				url = '../WmRoot/security-ports.dsp';
			}
			if(is_csrf_guard_enabled && needToInsertToken){
			createForm("htmlform_security_ports", url, "POST", "BODY");
			setFormProperty("htmlform_security_ports", _csrfTokenNm_, _csrfTokenVal_);
			document.htmlform_security_ports.submit();
			} else {
    ...
    <TABLE width="100%">
      ...
      <TR>
        <TD colspan="2">
          <UL>
            %ifvar webMethods-wM-AdminUI%
              <LI><A onclick="return returnToPort(true);" HREF="javascript:void(0)">Return to Ports</A></LI>
            %else%
              <LI><A onclick="return returnToPort(false);" HREF="javascript:void(0)">Return to Ports</A></LI>
            %endif%
            %ifvar mode equals('view')%
      ...
      <TR>
        ...
        <TD>
          <TABLE class="tableForm">
            ...
            <form id="properties" name="properties" method="post" action="../WmRoot/security-ports.dsp" onsubmit="return verify('%value encode(javascript) listenerKey%');">
        ...
        <tr><td class="heading" colspan=2>Polling Information</td></tr>
          <tr>
            ...
            <td id="monitorDirTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'monitorDir', '%value encode(javascript) monitorDir%','monitorDirTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">Working Directory (optional)</td>
            <td id="workDirTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'workDir', '%value encode(javascript) workDir%',
			  'workDirTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Completion Directory (optional)</td>
            <td id="completionDirTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'completionDir', '%value encode(javascript) completionDir%', 'completionDirTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">Error Directory (optional)</td>
            <td id="errorDirTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'errorDir', '%value encode(javascript) errorDir%',
			 'errorDirTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">File Name Filter (optional)</td>
            <td id="filterTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'fileNameFilter', '%value encode(javascript) fileNameFilter%', 'filterTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="evenrow">File Age (optional) (seconds)</td>
            <td id="fileAgeTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'fileAge', '%value encode(javascript) fileAge%',
			  'fileAgeTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Content Type (optional)</td>
            <td id="contentTypeTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'defaultContentType', '%value encode(javascript) defaultContentType%', 'contentTypeTd','properties');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td id="lockExtTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'lockFileExtension', '%value encode(javascript) lockFileExtension%', 'lockExtTd','properties');</script>
            </td>
          </tr>
          <tr>
			<td class="oddrow">Number of files to process per Interval (optional)</td>
			<td id="filesPerIntervalTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
			  <script>addInputTag('%value encode(javascript) mode%', 'maxFilesPerCycle', '%value encode(javascript) maxFilesPerCycle%', 'filesPerIntervalTd','properties');</script>
			</td>
          </tr>
          </table>
          </td>
	 	...
	 	<SCRIPT>
          ...
          <tr>
            ...
            <td id="processingServiceTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'processingService', '%value encode(javascript) processingService%', 'processingServiceTd','properties');</script>
            </td>
          </tr>

          <tr>
            <td class="evenrow">File Polling Interval (seconds)</td>
            <td id="filePollIntervalTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'filePollingInterval', '%value encode(javascript) filePollingInterval%','filePollIntervalTd','properties');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td id="cleanUpServiceTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'cleanUpService', '%value encode(javascript) cleanUpService%', 'cleanUpServiceTd','properties');</script>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td id="cleanUpFileAgeTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'cleanUpFileAge', '%value encode(javascript) cleanUpFileAge%', 'cleanUpFileAgeTd','properties');</script>
            </td>
            
          </tr>
          <tr>
            <td class="evenrow">Cleanup Interval (optional) (hours)</td>
            <td id="cleanUpIntervalTd" class="%ifvar ../mode equals('view')%evenrowdata-l%else%evenrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'cleanUpInterval', '%value encode(javascript) cleanUpInterval%','cleanUpIntervalTd','properties');</script>
            </td>
          </tr>
          <tr>
            <td class="oddrow">Maximum Number of Invocation Threads</td>
            <td id="maxThreadsTd" class="%ifvar ../mode equals('view')%oddrowdata-l%else%oddrow-l%endif%">
              <script>addInputTag('%value encode(javascript) mode%', 'maxThreads', '%value encode(javascript) maxThreads%','maxThreadsTd'
			  ,'properties');</script>
            </td>
          </tr>
